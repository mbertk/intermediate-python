...
class NearEarthObject:
    ...
    def __init__(self, designation, hazardous,  name=None, diameter=float('nan'), **info):
        ...
        :param name: IAU name of the object (string)
        :param diameter: Diameter of the object (float)
    ...
    def __str__(self):
        ...
        return f"{self.fullname} has a diameter of {self.diameter} km and " \
...
class CloseApproach:
    ...
    def __init__(self, designation, time, distance, velocity, **info):
        ...
        :param _designation: Designation of the object (string)
        :param time: date and time of the approach (calendar date in YYYY-bb-DD hh:mm format)
        :param distance: Distance of the approach (float)
        :param velocity: Velocity of the object (float)
        :param info: A dictionary of excess keyword arguments supplied to the constructor.
        """
        # TODO: Assign information from the arguments passed to the constructor
    ...
    def __str__(self):
        ...
        return f"At {self.time_str}, {self.neo.fullname} approaches Earth at a distance of " \
               f"{self.distance:.2f} au and as velocity of {self.velocity:.2f} km/s."
